...
export const metadata: Metadata = {
  title: "상권분석 MVP",
  description: "서울 성수권 mock/sample subset 기반 상권 적합도 분석 서비스"
};
    ...
    <main className="pageShell">
      <section className="heroCard">
        <div className="heroCopy">
          ...
          <p className="lead">
            이 MVP는 성수권 mock sample data와 sample subset 구조를 기준으로 작동합니다. LLM은
            계산된 metric을 설명할 뿐, 상권 사실을 새로 만들어내지 않습니다.
          </p>
